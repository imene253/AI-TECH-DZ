        ...
        <div className="flex flex-col items-center justify-center text-center gap-10">
          ...
          <div>
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center">
              <p className="text-sm md:text-base hover:text-[#000000] cursor-pointer transition-colors">فايسبوك</p>
              <p className="text-sm md:text-base hover:text-[#000000] cursor-pointer transition-colors">انستغرام</p>
            </div>
          </div>
        </div>
      </div>
